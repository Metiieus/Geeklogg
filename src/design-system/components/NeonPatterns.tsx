    ...
    minimal: (
      <svg viewBox="0 0 400 40" className="w-full h-full">
        ...
        <g transform="translate(200,20)">
          ...
          <circle r="8" fill="none" stroke={colorValue} strokeWidth="1" opacity={opacity * 0.5} />
        </g>
      </svg>
    ),
  ...
  const ornaments = {
      ...
      <svg viewBox="0 0 100 100" className="w-full h-full">
        <defs>
          ...
          <radialGradient id={`ornament-gradient-${color}`}>
            ...
            <stop offset="100%" stopColor={colorValue} stopOpacity={opacity * 0.3} />
          </radialGradient>
        </defs>
    ...
    center: (
      <svg viewBox="0 0 120 60" className="w-full h-full">
        ...
        <g transform="translate(60,30)">
          <circle r="20" stroke={colorValue} strokeWidth="2" fill="none" opacity={opacity} filter={`url(#center-glow-${color})`} />
          <circle r="15" stroke={colorValue} strokeWidth="1" fill="none" opacity={opacity * 0.8} />
          <circle r="10" stroke={colorValue} strokeWidth="1" fill="none" opacity={opacity * 0.6} />
          <circle r="5" stroke={colorValue} strokeWidth="1" fill="none" opacity={opacity * 0.4} />
    ...
    side: (
      <svg viewBox="0 0 40 120" className="w-full h-full">
        ...
        {/* Side ornaments */}
        <circle cx="20" cy="30" r="3" fill={colorValue} opacity={opacity * 0.8} />
        <circle cx="20" cy="60" r="3" fill={colorValue} opacity={opacity * 0.8} />
        <circle cx="20" cy="90" r="3" fill={colorValue} opacity={opacity * 0.8} />
