      ...
      <div className={`relative ${className}`}>
        ...
        >
          ...
          <div className="absolute left-3 sm:left-4 top-1/2 -translate-y-1/2 z-10">
            <div
              className={`text-white/60 transition-colors duration-200 ${isFocused ? "text-cyan-400" : ""}`}
            >
              {icon}
            </div>
          </div>
    ...
    <div className={`relative ${className}`}>
      ...
      >
        ...
        <div className="flex items-center h-11 sm:h-12 px-3 sm:px-4">
          <div
            className={`text-white/60 mr-2 sm:mr-3 transition-colors duration-200 ${isOpen ? "text-violet-400" : ""}`}
          >
            {icon}
          </div>

          <span
            className={`flex-1 text-white text-sm sm:text-base ${!selectedOption ? "text-white/50" : ""} truncate`}
          >
