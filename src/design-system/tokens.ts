...
export const typography = {
  fontFamily: {
    primary:
      '"TT Commons", system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif',
...
export const shadows = {
  ...
  glow: {
    ...
    emerald:
      "0 20px 25px -5px rgba(5, 150, 105, 0.3), 0 10px 10px -5px rgba(5, 150, 105, 0.1)",
...
export const getCategoryGradient = (
  category: keyof typeof gradients.categories,
) => {
