        ...
        <div className="flex items-center justify-between p-6 border-b border-white/20">
          <div>
            ...
            <p className="text-sm text-white/60 mt-1">
              Selecione até 5 itens para destacar na sua biblioteca ({localSelected.length}/5)
            </p>
          </div>
          <button 
            onClick={onClose} 
          ...
          {filteredItems.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-slate-400">
                {searchQuery ? 'Nenhum item encontrado' : 'Sua biblioteca está vazia'}
              </p>
            </div>
          ) : (
                  ...
                  >
                    ...
                    >
                      <div className="text-center">
                        ...
                        <span className="text-white/60 text-xs">{typeLabels[item.type]}</span>
                      </div>
                    </div>
                    ...
                    {!canSelect && !selected && (
                      <div className="absolute inset-0 bg-black/60 flex items-center justify-center">
                        <div className="text-center">
                          <span className="text-white/60 text-xs font-medium">Máximo</span>
                          <span className="text-white/60 text-xs font-medium block">atingido</span>
                        </div>
                      </div>
                    )}
