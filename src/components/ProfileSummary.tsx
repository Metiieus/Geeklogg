...
const ProfileSummary: React.FC = () => {
  ...
  const totalInProgress = mediaItems.filter(
          ...
          <div className="space-y-3">
            {recentActivity.length > 0 ? (
              recentActivity.map((item) => (
                <div
                  key={item.id}
                  className="flex items-center gap-3 p-3 bg-slate-800/40 rounded-lg hover:bg-slate-800/60 transition-colors"
                >
          ...
          <div className="space-y-3">
            {topRated.length > 0 ? (
              topRated.map((item, index) => (
                <div
                  key={item.id}
                  className="flex items-center gap-3 p-3 bg-gradient-to-r from-yellow-500/5 to-orange-500/5 rounded-lg border border-yellow-500/20"
                >
