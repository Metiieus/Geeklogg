  ...
  return (
    <form onSubmit={handleSubmit} className="max-w-sm mx-auto mt-20 space-y-4 text-white">
      ...
      <div className="flex gap-2">
        <button type="submit" className="flex-1 bg-purple-600 px-4 py-2 rounded-lg">Registrar</button>
        <button type="button" onClick={onCancel} className="flex-1 bg-slate-600 px-4 py-2 rounded-lg">Voltar</button>
      </div>
    </form>
  );
};
