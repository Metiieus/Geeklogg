...
import { ArrowLeft, Trash2, AlertTriangle, Shield, Download, Clock } from "lucide-react";
    ...
    <div className="space-y-6">
      <div className="bg-red-500/10 border border-red-500/30 rounded-xl p-6">
        <div className="flex items-center mb-4">
          ...
          <h3 className="text-lg font-semibold text-red-400">Atenção: Ação Irreversível</h3>
        </div>
        <p className="text-gray-300 leading-relaxed">
          A exclusão da sua conta é <strong>permanente e irreversível</strong>. Todos os seus dados 
      ...
      <div className="bg-blue-500/10 border border-blue-500/30 rounded-xl p-6">
        <div className="flex items-center mb-4">
          ...
          <h3 className="text-lg font-semibold text-blue-400">Exportar Dados (Recomendado)</h3>
        </div>
        <p className="text-gray-300 leading-relaxed mb-4">
          Antes de excluir sua conta, recomendamos que você exporte seus dados. 
          Isso criará um arquivo com todas as suas informações que você poderá manter.
        </p>
        <button
      ...
      <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-xl p-6">
        <div className="flex items-center mb-4">
          ...
          <h3 className="text-lg font-semibold text-yellow-400">Período de Reflexão</h3>
        </div>
        <p className="text-gray-300 leading-relaxed">
    ...
    <div className="space-y-6">
      <div className="bg-red-500/10 border border-red-500/30 rounded-xl p-6">
        <div className="flex items-center mb-4">
          ...
          <h3 className="text-lg font-semibold text-red-400">Confirmação Final</h3>
        </div>
        <p className="text-gray-300 leading-relaxed mb-4">
          Esta é sua última chance de reconsiderar. Uma vez confirmada, a exclusão não pode ser desfeita.
        </p>
        
        <div className="bg-gray-900/50 rounded-lg p-4 mb-4">
          <p className="text-sm text-gray-400 mb-2">
            Para confirmar, digite exatamente: <span className="text-red-400 font-mono">EXCLUIR CONTA</span>
          </p>
          <input
            type="text"
      ...
      <div className="relative z-10 container mx-auto px-4 py-8 max-w-3xl">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-2">
            <span className={`text-sm ${step === 'warning' ? 'text-white' : 'text-gray-400'}`}>
              Aviso
            </span>
            <span className={`text-sm ${step === 'confirmation' ? 'text-white' : 'text-gray-400'}`}>
              Confirmação
            </span>
          </div>
        ...
        <div className="mt-6 bg-gray-800/30 rounded-xl p-6 border border-gray-700/50">
          <div className="flex items-start">
            ...
            <div className="text-sm text-gray-300">
              ...
              <p>
                Seguimos rigorosamente a LGPD e outras regulamentações de proteção de dados. 
                Seus dados serão excluídos de forma segura e definitiva dentro de 30 dias.
              </p>
            </div>
          </div>
        </div>
