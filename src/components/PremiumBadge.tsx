    ...
    switch (variant) {
      case 'avatar':
        return (
          ...
          >
            <Crown className={`${sizeClasses.icon} text-white drop-shadow-sm`} />
            {animated && (
              <motion.div
      ...
      case 'inline':
        return (
          ...
          >
            ...
            {showLabel && (
              <span className={`${sizeClasses.text} text-yellow-400 font-medium`}>
                Premium
              </span>
            )}
          </motion.div>
      ...
      case 'chip':
        return (
          ...
          >
            ...
            <span className={`${sizeClasses.text} text-white font-semibold tracking-wide`}>
              PREMIUM
            </span>
      ...
      default:
        return (
          ...
          >
            <Crown className={`${sizeClasses.icon} text-yellow-400 drop-shadow-sm`} />
          </motion.div>
        );
    }
  };
...
export const ConditionalPremiumBadge: React.FC<ConditionalPremiumBadgeProps> = ({
  isPremium,
  ...badgeProps
}) => {
